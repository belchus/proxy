...
const celdasProductos = document.getElementById('myProds')
const celdasProductosR = document.getElementById('myProds-r')
...
function newMsn() {
    ...
    if(email == ""){
        return(alert('Ingrese su email para enviar mensajes'));
    } else if(nombre == "") {
        return(alert('Debe ingresar su nombre'));
    } else if (apellido == "") {
        return(alert('Debe ingresar su apellido'));
    } else if(edad == "") {
        return(alert('Debe ingresar su'));
    } else if (alias == "") {
        return(alert('Debe ingresar su alias'));
    } else if (thumbnail == "") {
        return(alert('Debe ingresar un avatar '));
    } else if (text == "") {
        return(alert('el campo no debe estar en blanco'));
    } else {
